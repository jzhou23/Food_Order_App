package com.example.jhzhou.foodordercustomer.entity;
...
public class Food implements Parcelable {
    ...
    public Food(String name, double price, int category, String image, int spicy, double rating, String description, Map<String, Double> ingredients, boolean isSpecial, int percentOff) {
        mName = name;
        mPrice = price;
        mCategory = category;
        mImage = image;
